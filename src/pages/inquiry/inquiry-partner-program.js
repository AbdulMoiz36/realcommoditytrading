...
const InquiryPartnerProgram = () => {
  const [name, setName] = useState("");
  const [email, setEmail] = useState("");
  const [inquiry, setInquiry] = useState("");
  const userId = sessionStorage.getItem("userId");
  const inquiryType = "inquiry-partner-programe";
  ...
  return (
    ...
    <div className="w-full flex justify-center items-center">
      <div className="lg:p-20 md:p-10 py-10 px-3 shadow-2xl border-2 my-10 w-6/6 md:w-5/6 lg:w-4/6 flex flex-col md:items-center gap-10">
        <h1 className="text-center text-3xl m-5  md:text-4xl font-bold mb-3">Inquiry On Partner Program</h1>
...
export default InquiryPartnerProgram